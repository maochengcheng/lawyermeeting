            ...
            <div class="m-b-40">
                <div class="flex-row flex-between m-b-20">
                    ...
                    <div class="w-40 flex-row">
                        <div>会见类型：</div>
                        <div>
                            <div>{{ current.type == 'OFFLINE' ? '预约会见' : '远程会见' }}</div>
                        </div>
                    </div>
                </div>
                <div class="flex-row flex-between m-b-20">
                    ...
                    <div class="w-30 flex-row">
                        <div>是否初次会见：</div>
                        <div>{{ current.isFirst ? '是' : '否' }}</div>
                    </div>
                    <div class="w-40 flex-row">
                        <div>会见{{current.type=='远程会见'?'派出所':'看守所'}}：</div>
...
export default {
    ...
    data() {
        ...
        return {
            ...
            rules: {
                ...
                detentionCenterId: [{ required: true, message: '请选择派出所', trigger: 'blur' }],
    ...
    watch: {
        ...
        'lay.type'(val) {
            if (val == 'OFFLINE') {
                this.lay.detentionCenterName = '海淀看守所';
    ...
    methods: {
        ...
        getLaywerList() {
            ...
            this.ax.get('attorneyManagement/attorney', query).then(res => {
