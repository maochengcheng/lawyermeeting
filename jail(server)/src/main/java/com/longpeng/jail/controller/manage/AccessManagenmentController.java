...
//    }
    ...
    @PermissionDes(menu = "预约记录",name = "获取看守所列表")
    @ApiOperation("获取看守所列表")
    ...
    public API<List<AppointmentSettings>> obtainAppointmentSettings(@RequestParam("type")Integer type){
        List<AppointmentSettings> appointmentSettings = accessService.obatinAppointmentSettings(type);
